...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Editora',
            fields=[
                ('pessoajuridica_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='app.pessoajuridica')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_publicacao', models.DateField(blank=True, default='2000-01-01', null=True, verbose_name='Data de Publicação')),
